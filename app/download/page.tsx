  ...
  return (
    <main className="relative overflow-hidden">
      ...
      <div className="relative mx-auto w-full max-w-7xl px-5 pb-24 pt-16 sm:px-8">
        ...
        <aside className="mt-12 rounded-3xl border border-ink/10 bg-ink/[0.03] p-6 text-sm leading-6 text-ink/55">
          Verify checksums with{" "}
          <code className="font-mono text-ink/80">shasum -a 256</code> on
          macOS/Linux or{" "}
          <code className="font-mono text-ink/80">Get-FileHash -Algorithm SHA256</code>{" "}
